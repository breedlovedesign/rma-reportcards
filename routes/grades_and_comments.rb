...
post "/grading/submit/:student_id/:skill_track_id" do
	...
	unless form["language_arts_outcome_set.id"].nil? 
	...
	unless form["math_outcome_set.id"].nil? 
	...
	unless form["social_studies_outcome_set.id"].nil? 
	...
	unless form["science_outcome_set.id"].nil? 
	...
	unless form["work_study_outcome_set.id"].nil? 
	...
	unless form["citizenship_outcome_set.id"].nil? 
	...
	unless form["art_outcome_set.id"].nil? 
	...
	unless form["ict_outcome_set.id"].nil? 
	...
	unless form["music_outcome_set.id"].nil? 
	...
	unless form["pe_outcome_set.id"].nil? 
	...
	unless form["thai_outcome_set.id"].nil? 
